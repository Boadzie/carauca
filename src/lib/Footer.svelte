<footer class="text-lg text-gray-600 body-font">
    <hr class="h-1 tomato-bg"/>
    <div class="container px-5 py-24 mx-auto">
      <div class="flex flex-wrap order-first text-center md:text-left">
        <div class="w-full px-4 lg:w-1/4 md:w-1/2">
          <h2 class="mb-3 font-medium tracking-widest text-gray-900 title-font">CATEGORIES</h2>
        ...
        <div class="w-full px-4 lg:w-1/4 md:w-1/2">
          ...
          <div class="flex flex-wrap items-end justify-center xl:flex-nowrap md:flex-nowrap lg:flex-wrap md:justify-start">
            <div class="relative w-full mr-2 sm:w-auto xl:mr-4 lg:mr-0 sm:mr-4">
              
              <input type="text" id="footer-field" name="footer-field" class="w-full px-3 py-1 text-base leading-8 text-gray-700 transition-colors duration-200 ease-in-out bg-gray-100 bg-opacity-50 border border-gray-300 rounded outline-none focus:bg-transparent focus:ring-2 focus:ring-indigo-200 focus:border-indigo-500">
            </div>
            <button class="inline-flex items-center justify-center flex-shrink-0 w-full px-6 py-2 text-white border-0 rounded tomato-bg lg:mt-2 xl:mt-0 focus:outline-none hover:bg-red-600">Subscribe</button>
          </div>
    ...
    <div class="bg-gray-100">
      <div class="container flex flex-col items-center px-5 py-6 mx-auto sm:flex-row">
        <a href="/" class="flex items-center justify-center font-medium text-gray-900 title-font md:justify-start">
          ...
          <span class="ml-3 text-xl">Caracua</span>
        </a>
        <p class="mt-4 text-sm text-gray-500 sm:ml-6 sm:mt-0">© 2020 Tailblocks —
